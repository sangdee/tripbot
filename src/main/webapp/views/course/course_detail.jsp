...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/views/styles2/responsive.css">
    ...
    <!--custom css -->
    <link rel="stylesheet" type="text/css" href="/views/styles2/custom_course_detail_font.css">
</head>
<body>
                        ...
                        <div class="header_content_inner d-flex flex-row align-items-end justify-content-start">
                            ...
                            <nav class="main_nav">
                                <ul class="d-flex flex-row align-items-start justify-content-start">
                                    ...
                                    <li class="active"><a href="/course_list">게시판</a></li>
    ...
    <div class="home">
        ...
        <div class="home_slider_container">
            <div class="owl-carousel owl-theme home_slider">
                ...
                <!-- Slide -->
                <div class="owl-item">
                    <div class="background_image" style="background-image:url(/views//images/courseimage.jpg)"></div>
                    ...
                    <div class="intro_container">
                        <div class="row">
                            <div class="col text-center">
                                ...
                                <div class="section_title"><h2>유저 코스 게시판</h2></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <c:forEach var="board" items="${boards}">
                            <div class="news_post d-flex flex-md-row flex-column align-items-start justify-content-start">
                                <c:forEach var="image" items="${images}">
                                    <c:if test="${image.fno eq board.fno}">
                                        <div class="news_post_image"><img src="/views/uploadfiles/${image.getFilename()}" alt=""></div><hr>
                                    </c:if>
                                </c:forEach>
                ...
                <form name="commentInsertForm">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                           <button class="btn btn-default" onclick="alert('로그인이 필요한 서비스입니다.')" >등록</button>
                        </span>
                        <%}else{%>
                        <span class="input-group-btn">
