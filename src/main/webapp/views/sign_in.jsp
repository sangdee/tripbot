...
<head>
    ...
    <meta charset="UTF-8" />
    <!-- 구 css -->
    <link rel="stylesheet" href="css/sign_in.css" type="text/css" media="all" />
    ...
    <link rel="stylesheet" href="styles2/sign_in.css" type="text/css" media="all" />
</head>
...
<div class="menu">
    <div class="menu_header d-flex flex-row align-items-center justify-content-start">
        <div class="menu_logo"><a href="/views/.jsp">TripBot</a></div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/sign_in.do" method="post">
                ...
                <div class="right-w3l" >
                    <input type="submit" class="form-control" style="" value="로그인">
                </div>
                <div class="row sub-w3l">

                </div>
                <p class="text-center dont-do">회원이 아니신가요?
                    <a href="sign_up.jsp">회원 가입</a>
                </p>
            </form>
        </div>
